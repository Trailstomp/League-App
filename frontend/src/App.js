...
const EventsPage = ({teams, leagueSchedule, onTeamClick, currentUser, websiteStyle, onUpdateRSVP, users, onSendNotification, onEventClick}) => {
                                    ...
                                    {team.calendar.filter(event => teamEventTypeFilters[event.type || 'other']).map(event => {
                                        if (event.type && event.type.toLowerCase() === 'tournament') {
                                            ...
                                            return (
                                                <div 
                                                    key={event.id} 
                                                    className="bg-yellow-50 p-4 rounded-lg shadow-sm border border-yellow-200 cursor-pointer hover:border-yellow-300 hover:shadow-md transition-all duration-200"
                                                    onClick={() => onEventClick && onEventClick(event)}
                                                >
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex-grow">
    ...
    const renderPage = () => {
        ...
        if (page === 'team' && selectedTeam) {
            ...
            switch (page) {
                ...
                case 'events': pageComponent = <EventsPage teams={teams} leagueSchedule={leagueSchedule} onTeamClick={(teamId) => navigate('team', teamId)} currentUser={currentUser} websiteStyle={websiteStyle} onUpdateRSVP={handleUpdateRSVP} users={users} onSendNotification={sendEventNotification} onEventClick={handleEventClick} />; break;
        ...
        <div className="min-h-screen bg-slate-100">
            ...
            <div className="w-full">
                ...
                <header className="sticky top-0 z-20">
                    ...
                    <GameTicker teams={teams} gameTickerData={gameTickerData} websiteStyle={websiteStyle} onTeamClick={(teamId) => navigate('team', teamId)} onNavigate={navigate} onEventClick={handleEventClick} />
                </header>
