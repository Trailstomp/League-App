  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case 'home':
        ...
        return <HomePage teams={teams} players={players} currentUser={currentUser} events={events} setEvents={setEvents} websiteStyle={websiteStyle} onNavigate={handleNavigate} homeTab={homeTab} onHomeTabUsed={() => setHomeTab(null)} />;
      case 'admin':
