                            ...
                            <div className="space-y-8">
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-blue-800">Social Media API Setup</h3>
                                            <p className="text-sm text-blue-700">
                                                Connect your social media accounts by adding API credentials. You can add them gradually as you obtain them.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-400">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-semibold text-slate-800">Twitter API</h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.twitter.api_secret}
                                                onChange={(e) => handleCredentialChange('twitter', 'api_secret', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => handleCredentialChange('twitter', 'access_token', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                                placeholder="Enter Access Token"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-slate-700 mb-1">Access Token Secret *</label>
                                            <input
                                                type="password"
                                                value={credentials.twitter.access_token_secret}
                                                onChange={(e) => handleCredentialChange('twitter', 'access_token_secret', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                                placeholder="Enter Access Token Secret"
                                            />
                                        </div>
                                        <div className="md:col-span-2">
                                            <label className="block text-sm font-medium text-slate-700 mb-1">Bearer Token (Optional)</label>
                                            <input
                                                type="password"
                                                value={credentials.twitter.bearer_token}
                                                onChange={(e) => handleCredentialChange('twitter', 'bearer_token', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                                placeholder="Enter Bearer Token (for read-only operations)"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-semibold text-slate-800">Facebook API</h3>
                                                <p className="text-sm text-slate-600">Get credentials from developers.facebook.com</p>
                                            </div>
                                        </div>
                                        <span className={`px-3 py-1 rounded text-sm font-medium ${
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                value={credentials.facebook.app_id}
                                                onChange={(e) => handleCredentialChange('facebook', 'app_id', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.facebook.app_secret}
                                                onChange={(e) => handleCredentialChange('facebook', 'app_secret', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.facebook.access_token}
                                                onChange={(e) => handleCredentialChange('facebook', 'access_token', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                                placeholder="Enter Page Access Token"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-slate-700 mb-1">Page ID (Optional)</label>
                                            <input
                                                type="text"
                                                value={credentials.facebook.page_id}
                                                onChange={(e) => handleCredentialChange('facebook', 'page_id', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-pink-500">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-semibold text-slate-800">Instagram Business API</h3>
                                                <p className="text-sm text-slate-600">Requires Facebook Developer Account</p>
                                            </div>
                                        </div>
                                        <span className={`px-3 py-1 rounded text-sm font-medium ${
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                value={credentials.instagram.app_id}
                                                onChange={(e) => handleCredentialChange('instagram', 'app_id', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.instagram.app_secret}
                                                onChange={(e) => handleCredentialChange('instagram', 'app_secret', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.instagram.access_token}
                                                onChange={(e) => handleCredentialChange('instagram', 'access_token', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                value={credentials.instagram.business_account_id}
                                                onChange={(e) => handleCredentialChange('instagram', 'business_account_id', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <input
                                                type="url"
                                                value={credentials.instagram.redirect_uri}
                                                onChange={(e) => handleCredentialChange('instagram', 'redirect_uri', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                                placeholder="https://your-app.com/auth/instagram/callback"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-red-500">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-semibold text-slate-800">YouTube Data API</h3>
                                                <p className="text-sm text-slate-600">Get credentials from console.cloud.google.com</p>
                                            </div>
                                        </div>
                                        <span className={`px-3 py-1 rounded text-sm font-medium ${
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.youtube.client_id}
                                                onChange={(e) => handleCredentialChange('youtube', 'client_id', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.youtube.client_secret}
                                                onChange={(e) => handleCredentialChange('youtube', 'client_secret', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="password"
                                                value={credentials.youtube.refresh_token}
                                                onChange={(e) => handleCredentialChange('youtube', 'refresh_token', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                value={credentials.youtube.channel_id}
                                                onChange={(e) => handleCredentialChange('youtube', 'channel_id', e.target.value)}
                                                className="w-full p-2 border rounded-lg"
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg">
                                    <h3 className="font-semibold text-gray-800 mb-4">How to Get API Credentials</h3>
                                    <div className="space-y-4 text-sm text-gray-700">
                                        <div>
                                            <h4 className="font-medium text-blue-600">Twitter:</h4>
                                            <p>1. Go to <a href="https://developer.twitter.com" target="_blank" className="text-blue-600 underline">developer.twitter.com</a></p>
                                            <p>2. Create a new project and app</p>
                                            <p>3. Generate API keys and access tokens</p>
                                        </div>
                                        <div>
                                            <h4 className="font-medium text-blue-600">Facebook:</h4>
                                            <p>1. Go to <a href="https://developers.facebook.com" target="_blank" className="text-blue-600 underline">developers.facebook.com</a></p>
                                            <p>2. Create a new app with "Business" type</p>
                                            <p>3. Add Facebook Pages product and generate page access token</p>
                                        </div>
                                        <div>
                                            <h4 className="font-medium text-pink-500">Instagram:</h4>
                                            <p>1. Use same Facebook app from above</p>
                                            <p>2. Add Instagram Basic Display product</p>
                                            <p>3. Convert personal Instagram to business account</p>
                                            <p>4. Connect Instagram business account to Facebook page</p>
                                        </div>
                                        <div>
                                            <h4 className="font-medium text-red-600">YouTube:</h4>
                                            <p>1. Go to <a href="https://console.cloud.google.com" target="_blank" className="text-red-600 underline">Google Cloud Console</a></p>
                                            <p>2. Create new project and enable YouTube Data API v3</p>
                                            <p>3. Create OAuth 2.0 credentials</p>
                                            <p>4. Use OAuth playground to get refresh token</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
