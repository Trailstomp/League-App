...
// --- SIMPLIFIED IMAGE CROP TOOL (TEMPORARILY DISABLED) ---
const ImageCropTool = ({ imageUrl, onCrop, onCancel }) => {
    const handleSave = () => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                ...
                <div className="mb-6">
                    <img src={imageUrl} alt="Selected" className="w-full max-h-64 object-contain rounded" />
                </div>
                
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                    <p className="text-sm text-yellow-800">
                        <strong>Advanced crop tool temporarily disabled</strong> to resolve technical issues. 
                        Your image will be used as-is for now. Full cropping functionality will be restored soon.
                    </p>
                </div>
