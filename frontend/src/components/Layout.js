...
const Layout = ({ 
    ...
    return (
        <div>
            ...
            <div style={{...getBackgroundStyle(), paddingTop: '180px', minHeight: '100vh'}}>
                {/* Mobile Navigation Overlay */}
                {isMobileMenuOpen && (
                    <div 
                        className="fixed inset-0 bg-black bg-opacity-50 z-30 md:hidden"
                        style={{top: '180px'}} // Position below header
                    />
                )}
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            top: '174px', // Just below header with padding
                    ...
                    <main 
                        ...
                        style={{
                            ...
                            minHeight: 'calc(100vh - 164px)', // Ensure full height below header
