                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-4 md:p-6 space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setNewUser(prev => ({ ...prev, emergencyContactName: e.target.value }))}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setNewUser(prev => ({ ...prev, emergencyContactPhone: e.target.value }))}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setNewUser(prev => ({ ...prev, emergencyContactRelationship: e.target.value }))}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                        >
                            ...
                            {/* Player-Specific Sections - Only show when player role is selected */}
                            {newUser.roles.includes('player') && (
                                <>
                                    {/* Lacrosse History Section */}
                                    <div className="border-t pt-4">
                                        <h4 className="font-medium text-gray-700 mb-3 flex items-center gap-2">
                                            🥍 Lacrosse History
                                        </h4>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-4 md:p-6 space-y-4">
                            ...
                            {/* Player-Specific Sections - Only show when user has player role */}
                            {(editingUser.roles?.includes('player') || editingUser.role === 'player') && (
                                <>
                                    ...
                                    <div className="border-t pt-4">
                                        <h4 className="font-medium text-gray-700 mb-3 flex items-center gap-2">
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                    <input
                                                        type="text"
                                                        placeholder="Team Name"
                                                        value={editingUser.lacrosseHistory?.highSchool?.teamName || ''}
                                                    ...
                                                    <input
                                                        type="text"
                                                        placeholder="Graduation Year"
                                                        value={editingUser.lacrosseHistory?.highSchool?.graduationYear || ''}
                                                        onChange={(e) => setEditingUser(prev => ({
                                                            ...prev,
                                                            lacrosseHistory: {
                                                                ...prev.lacrosseHistory,
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                    <input
                                                        type="text"
                                                        placeholder="Team Name"
                                                        value={editingUser.lacrosseHistory?.college?.teamName || ''}
                                                        onChange={(e) => setEditingUser(prev => ({
                                                            ...prev,
                                                            lacrosseHistory: {
                                                                ...prev.lacrosseHistory,
                                                    ...
                                                    <input
                                                        type="text"
                                                        placeholder="Graduation Year"
                                                        value={editingUser.lacrosseHistory?.college?.graduationYear || ''}
                                                        onChange={(e) => setEditingUser(prev => ({
                                                            ...prev,
                                                            lacrosseHistory: {
                                                                ...prev.lacrosseHistory,
                                            ...
                                            <div>
                                                ...
                                                {(editingUser.lacrosseHistory?.postGrad || []).map((team, idx) => (
                                                    <div key={idx} className="flex gap-2 mb-2">
                                                        <input
                                                            type="text"
                                                            placeholder="Team Name"
                                                            value={team.teamName || ''}
                                                            onChange={(e) => {
                                                                const updated = [...(editingUser.lacrosseHistory?.postGrad || [])];
                                                                updated[idx] = { ...updated[idx], teamName: e.target.value };
                                                                setEditingUser(prev => ({
                                                                    ...prev,
                                                                    lacrosseHistory: { ...prev.lacrosseHistory, postGrad: updated }
                                                        ...
                                                        <button
                                                            type="button"
                                                            onClick={() => {
                                                                const updated = (editingUser.lacrosseHistory?.postGrad || []).filter((_, i) => i !== idx);
                                                                setEditingUser(prev => ({
                                                                    ...prev,
                                                                    lacrosseHistory: { ...prev.lacrosseHistory, postGrad: updated }
                                                                }));
                                    ...
                                    <div className="border-t pt-4">
                                        ...
                                        <textarea
                                            placeholder="Share some fun facts about yourself... (favorite food, hobbies, interesting trivia, etc.)"
                                            value={editingUser.funFacts || ''}
                                            onChange={(e) => setEditingUser(prev => ({ ...prev, funFacts: e.target.value }))}
                                            rows={3}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg resize-none"
                                        />
                                    </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <input
                                                        type="text"
                                                        placeholder="TikTok username"
                                                        value={editingUser.socialMedia?.tiktok || ''}
                                                        onChange={(e) => setEditingUser(prev => ({
                                                            ...prev,
                                                            socialMedia: { ...prev.socialMedia, tiktok: e.target.value }
                                                        }))}
