...
from routes import finance_router, locations_router, teams_router, users_router, rsvp_router, set_finance_db, set_locations_db, set_teams_db, set_users_db, set_rsvp_db
...
async def _send_groupme_message_with_rsvp(bot_id: str, text: str, event_id: str, image_url: str = None) -> bool:
    ...
    try:
        ...
        base_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://leaguepro-2.preview.emergentagent.com')
